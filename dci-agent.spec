...
install -p -D -m 0644 %{SOURCE1} %{buildroot}%{_sysconfdir}/dci_agent.conf
install -p -D -m 0644 %{SOURCE2} %{buildroot}%{_sysconfdir}/dci_agent.conf.d/ansible.conf.sample
install -p -D -m 0644 %{SOURCE3} %{buildroot}%{_sysconfdir}/dci_agent.conf.d/email.conf.sample
install -p -D -m 0644 %{SOURCE4} %{buildroot}%{_sysconfdir}/dci_agent.conf.d/file.conf.sample
install -p -D -m 0644 %{SOURCE5} %{buildroot}%{_sysconfdir}/dci_agent.conf.d/irc.conf.sample
install -p -D -m 0644 %{SOURCE6} %{buildroot}%{_sysconfdir}/dci_agent.conf.d/mirror.conf.sample
install -p -D -m 0644 %{SOURCE7} %{buildroot}%{_sysconfdir}/dci_agent.conf.d/tests.conf.sample
